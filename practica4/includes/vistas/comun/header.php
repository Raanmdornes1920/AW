        ...
        <div class="container-fluid px-3 px-lg-4">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow">
                    ...
                    <?php if ($_SESSION['usuario']->rol() === 'gerente'): ?>
                        <li><a class="dropdown-item" href="<?php echo RUTA_VISTAS; ?>/usuarios/ajustes_admin.php"><i
                                    class="bi bi-person-gear"></i> Administrar Perfiles</a></li>
                    <?php endif; ?>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a href="<?php echo RUTA_INCLUDES; ?>/vistas/usuarios/apoyo/logout.php"
                            class="dropdown-item text-danger"><i class="bi bi-box-arrow-left"></i> Cerrar Sesión</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="collapse navbar-collapse order-4 order-lg-2" id="menuPrincipal">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-center">
                    <li class="nav-item">
                        <a class="nav-link <?php echo clase_activa('index.php', $pagina_actual); ?>"
                            href="<?php echo RAIZ_APP; ?>/">Inicio</a>
                    </li>

                    <?php if ($_SESSION['usuario']->rol() === 'gerente'): ?>
                        <li class="nav-item"><a
                                class="nav-link <?php echo clase_activa('categorias_gerente.php', $pagina_actual); ?>"
                                href="<?php echo RUTA_VISTAS; ?>/categorias/categorias_gerente.php">Categorías</a></li>
                        <li class="nav-item"><a
                                class="nav-link <?php echo clase_activa('productos_gerente.php', $pagina_actual); ?>"
                                href="<?php echo RUTA_VISTAS; ?>/productos/productos_gerente.php">Productos</a></li>
                        <li class="nav-item"><a
                                class="nav-link <?php echo clase_activa('ofertas_gerente.php', $pagina_actual); ?>"
                                href="<?php echo RUTA_VISTAS; ?>/ofertas/ofertas_gerente.php">Ofertas</a></li>
                        <li class="nav-item"><a
                                class="nav-link <?php echo clase_activa('pedidos_gerente.php', $pagina_actual); ?>"
                                href="<?php echo RUTA_VISTAS; ?>/pedidos/pedidos_gerente.php">Supervisar Pedidos</a></li>
                    <?php elseif ($_SESSION['usuario']->rol() === 'cliente'): ?>
                        <li class="nav-item"><a
                                class="nav-link <?php echo clase_activa('productos_cliente.php', $pagina_actual); ?>"
                                href="<?php echo RUTA_VISTAS; ?>/productos/productos_cliente.php<?= (isset($_GET['tipo']) ? "?tipo=" . $_GET['tipo'] : "") ?>">Carta</a>
                        </li>
                        <li class="nav-item"><a
                                class="nav-link <?php echo clase_activa('ofertas_cliente.php', $pagina_actual); ?>"
                                href="<?php echo RUTA_VISTAS; ?>/ofertas/ofertas_cliente.php<?= (isset($_GET['tipo']) ? "?tipo=" . $_GET['tipo'] : "") ?>">Ofertas</a>
                        </li>
                        <li class="nav-item"><a
