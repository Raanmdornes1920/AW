...
if (empty($productos)) {
    ...
    foreach ($productos as $p) {
        ...
        <div class="tarjeta-item">
            <a href="productos_detalle.php?id=$idProd" style="text-decoration:none; color:inherit;">
                <img src="$imagen" alt="$nombre">
                <h4>$nombre</h4>
            </a>
            <p class="precio">$precio €</p>
            <button class="boton-iniciar-pedido" style="margin-bottom: 15px;">Añadir</button>
        </div>
EOF;
    }
}
...
<div class="contenedor-pedido">
    <aside class="menu-lateral">
        <h3>Menú</h3>
        <ul>
            <li><a href="../categorias/categorias_cliente.php">Categorías</a></li>
            <li><a href="productos_cliente.php">Todos los productos</a></li>
        </ul>
    </aside>
