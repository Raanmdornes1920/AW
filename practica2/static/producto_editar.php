...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    mysqli_stmt_bind_param($stmt,"issdiiii", $id_categoria, $nombre, $descripcion, $precio_base, $iva, $disponible, $ofertado, $id);
...
<form action="producto_editar.php" method="post" enctype="multipart/form-data">
    ...
    <a href="../vistas/productos.php">Cancelar</a>
</form>
</section>
